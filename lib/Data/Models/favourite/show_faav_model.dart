...
GetFavoriteResponseModel getFavoriteResponseModelFromJson(String str) =>
    GetFavoriteResponseModel.fromJson(json.decode(str));

String getFavoriteResponseModelToJson(GetFavoriteResponseModel data) =>
